...
module Subscribers
  module FdshGateway
    ...
    class EsiMecDeterminationSubscriber
      ...
      subscribe(:on_esi_determination_complete) do |delivery_info, metadata, response|
        ...
        result = FinancialAssistance::Operations::Applications::Esi::H14::AddEsiMecDetermination.new.call({payload: payload, call_type: call_type})
