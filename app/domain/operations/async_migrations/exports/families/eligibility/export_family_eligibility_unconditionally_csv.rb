    ...
    module Exports
      module Families
        module Eligibility
          ...
          class ExportFamilyEligibilityUnconditionallyCsv < ::Operations::AsyncMigrations::Exports::BaseQueueCsvExport
            ...
            def build
              ...
              csv_f = CSV.open("redetermine_outstanding_families_eligibilities_report_unconditionally.csv", "ab")
              run_records(csv_f)
              csv_f.close
            end
