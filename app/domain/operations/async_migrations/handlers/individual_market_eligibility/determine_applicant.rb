      ...
      module IndividualMarketEligibility
        ...
        class DetermineApplicant
          ...
          def call(params)
            ...
            yield build_determinations(applicant)
            yield determine_qhp_eligibility(applicant)
            yield determine_csr_eligibility(applicant)
            Success(applicant)
          end
          ...
          # @param [IndividualMarket::Applicant] applicant
          # @return [Dry::Monads::Result]
          def determine_qhp_eligibility(applicant)
            ...
            if @applying_coverage
              ...
              generate_state_resident_basis(applicant)
          ...
          # @param [IndividualMarket::Application] application
          # @return [Dry::Monads::Result]
          def generate_state_resident_basis(applicant)
          ...
          def determine_csr_eligibility(applicant)
            ...
            csr_determination.bases.build({basis_kind: 'ai_an_attested', is_satisfied: applicant.demographics.indian_tribe_member}) if @applying_coverage

            Try do
              csr_determination.assign_attributes(csr_type: 'csr_limited')
