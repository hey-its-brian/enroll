  ...
  module Families
    class AddFinancialAssistanceEligibilityDetermination
      ...
      def generate_enrollments(application)
        ...
        result = Operations::Individual::OnNewDetermination.new.call({
                                                                       family: application.family.reload,
                                                                       year: application.assistance_year,
                                                                       determination_type: :financial_assistance
                                                                     })
