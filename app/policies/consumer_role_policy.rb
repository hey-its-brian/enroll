class ConsumerRolePolicy < ApplicationPolicy
  ...
  # or an active associated individual market family broker or assister.
  #
  ...
  # an active associated broker, an active associated assister, or an admin in the individual market,
  #
  ...
  def edit?
    ...
    if person
      if @user.has_hbx_staff_role?
        ...
        return true if hbx_staff_role.permission && (hbx_staff_role.permission.can_update_ssn || hbx_staff_role.permission.view_personal_info_page)
      end
  ...
  def ridp_verified?
    # NOTE: brokers, assisters and consumers both require consumer identity to be verified beyond ridp page
  ...
  def can_view_application_types?
    @user&.person&.hbx_staff_role&.permission&.can_view_application_types || false
  end

  def access_new_consumer_application_sub_tab?
    @user&.person&.hbx_staff_role&.permission&.can_access_new_consumer_application_sub_tab || false
  end
