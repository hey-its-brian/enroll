class Exchanges::HbxProfilesController < ApplicationController
  ...
  before_action :set_cache_headers, only: [:show, :family_index_dt, :user_account_index, :identity_verification, :broker_agency_index, :outstanding_verification_dt, :configuration, :inbox, :people_index]
