...
Releases are managed through the [GitHub Releases](https://github.com/ideacrew/enroll/releases) page.
...
6. GitHub Actions will automatically create a new release on the [GitHub Releases](https://github.com/ideacrew/enroll/releases) page with release notes. Confirm that the release was successfully published there and that all intended commits are included in the release.
