...
RSpec.describe Operations::AsyncMigrations::Exports::Families::Eligibility::ExportFamilyEligibilityCsv do
  ...
  let(:csv_file_path) { "redetermine_outstanding_families_eligibilities_report.csv" }
