...
RSpec.describe Operations::BenchmarkProducts::IdentifyTypeOfHousehold do
  describe '#call' do
    ...
    context 'valid input' do
      ...
      context 'with data_source is fa_application' do
        let(:enabled) { true }
                ...
                members: [
                  {
                    ...
                    relationship_with_primary: 'self',
                    date_of_birth: applicant1.dob,
                    coverage_start_on: start_of_year,
                    age_on_effective_date: applicant1_age
                  },
                  {
                    applicant_id: applicant2.id,
                    relationship_with_primary: 'spouse',
                    date_of_birth: applicant2.dob,
                    coverage_start_on: start_of_year,
                    age_on_effective_date: applicant2_age
                  }
                ]
              }
            ]
        ...
        context 'effective_on not same as coverage_start_on' do
          let(:applicant1_age) { 35 }
          let(:applicant2_age) { 35 }
        ...
        context 'child_only' do
          let(:applicant1_age) { 15 }
          let(:applicant2_age) { 15 }
        ...
        context 'both members are aged 19' do
          let(:applicant1_age) { 19 }
          let(:applicant2_age) { 19 }
      ...
      context 'with data_source is family' do
        let(:person1) do
