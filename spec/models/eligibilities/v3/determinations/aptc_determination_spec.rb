...
RSpec.describe Eligibilities::V3::Determinations::AptcDetermination, type: :model do
  ...
  let(:determination) { FactoryBot.create(:aptc_determination, eligibility: eligibility) }
