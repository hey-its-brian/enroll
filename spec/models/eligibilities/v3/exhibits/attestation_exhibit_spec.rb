...
RSpec.describe Eligibilities::V3::Exhibits::AttestationExhibit, type: :model do
  ...
  let(:exhibit) { FactoryBot.create(:attestation_exhibit, :with_document, evidence: evidence) }
