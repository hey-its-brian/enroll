...
RSpec.describe ContactProfile::WorkEmail, type: :model do
  ...
  let(:work_email) { FactoryBot.create(:contact_profile_work_email, email: email) }

  describe 'associations' do
    it 'is embedded in email' do
      expect(work_email.email).to be_a(ContactProfile::Email)
    end
  end
