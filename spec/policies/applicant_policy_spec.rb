...
if ExchangeTestingConfigurationHelper.individual_market_is_enabled?
  RSpec.describe ApplicantPolicy, dbclean: :after_each, type: :model do
      ...
      context 'when a valid user is logged in' do
        ...
        context 'when the user is an assigned broker' do
          ...
          before do
            ...
            primary_applicant.application.family.reload
          end
          ...
          context 'with active associated individual market certified broker' do
            context 'consumer RIDP is verified' do
              ...
              it 'grants access' do
                expect(subject).to permit(logged_in_user, primary_applicant)
              end
            end
        ...
        context 'when the user is a broker staff' do
          ...
          before do
            ...
            broker_agency_account
            broker_staff
            dependent_applicant.application.family.reload
          end
