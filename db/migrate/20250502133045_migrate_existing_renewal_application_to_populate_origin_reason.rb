...
# @class MigrateExistingRenewalApplicationToPopulateOriginReason
# This migration updates existing renewal Financial Assistance applications
...
#   RAILS_ENV=production bundle exec rails db:migrate:up VERSION="20250502133045"
#
...
class MigrateExistingRenewalApplicationToPopulateOriginReason < Mongoid::Migration
  ...
  def self.generate_csv(array_collection)
    ...
    file_name = "#{Rails.root}/renewal_migrated_applications_#{Date.today.strftime('%Y_%m_%d')}.csv"
