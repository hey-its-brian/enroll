...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.qhp_application.review_description' => "You’re almost done! Review the application summary below and make sure it’s correct. Select the ‘Edit Member Details’ button to go back to any section and make changes. When you’re finished, select ‘Continue to Next Step’.",
  ...
  :'en.qhp_application.show.application_details_description' => "Select 'Edit' to make updates to your information. Your changes won't be final until you submit your updated application.",
  ...
  :'en.qhp_applicant.show.return' => "Return to Application Info",
  :'en.qhp_application.show.member_details_description' => "Select 'Edit' to make updates to your information. Your changes won't be final until you submit your updated application.",
