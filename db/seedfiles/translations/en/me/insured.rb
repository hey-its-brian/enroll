...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.qhp_application.nav_header' => "Sign Up for Coverage",
  ...
  :'en.qhp_application.review_description' => "You're almost done! Review the application summary below and make sure it's correct. Select the “Edit“ button to go back to any section and make changes. When you’re finished, select 'Continue to Next Step'.",
  ...
  :'en.qhp_application.attestation.back_to_household' => "Back to All Household Members",
