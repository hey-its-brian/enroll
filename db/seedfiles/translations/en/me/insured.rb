...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.consumer_roles.auth_and_consent' => "Authorization and Consent",
  ...
  :'en.insured.consumer_roles.upload_ridp_documents.select_action' => "Select Action",
  :'en.insured.consumer_roles.upload_ridp_documents.outstanding_header' => "Household Members",
  :'en.insured.consumer_roles.upload_ridp_documents.action_items' => "Action Items",
  ...
  :'en.additional_information_needed' => "Additional Information Needed",
  :'en.additional_info_needed' => "Additional Info Needed",
  ...
  :'en.income_coverage_info' => "Income & Coverage Info",
  ...
  :'en.to' => "To",
  :'en.date' => "Date",
  :'en.application_year' => "Application Year",
  :'en.plan_year' => "Plan Year",
  :'en.pagination.showing_entries' => "Showing %{start_entry}-%{end_entry} of %{total_entries} entries",
  :'en.pagination.entries_per_page' => "entries per page",
  :'en.pagination.with' => "with",
  :'en.pagination.zero_entries_per_page' => "0 entries per page",
  :'en.insured.evidences.no_documents' => 'No documents found for the selected year.',
  ...
  :'en.insured.families.verifications.summary_disclaimer_3_redirect_text' => "Verification Forms and Documents",
  :'en.insured.families.verifications.summary_disclaimer_3_2' => " section on CoverME.gov. If the document you uploaded was rejected, review your DMI again to confirm you uploaded the appropriate document. The CoverME.gov Consumer Assistance Center is available for assistance at 866-636-0355 / TTY:711.",
  ...
  :'en.insured.families.verifications.types.evidences_type_american_indian' => "American Indian Status",
  :'en.insured.families.verifications.types.evidences_type_immigration_status' => "Immigration Status",
  :'en.insured.families.verifications.types.evidences_type_citizenship' => "Citizenship",
  :'en.insured.families.verifications.types.evidences_type_social_security_number' => "Social Security Number",
  ...
  :'en.insured.families.verifications.statuses.in_review' => "In Review",
  ...
  :'en.insured.families.verifications.detail' => "Verification Detail",
  :'en.insured.families.verifications.detail.summary.member_status' => "Member Status",
  :'en.insured.families.verifications.detail.summary.status' => "Verification Status",
  :'en.insured.families.verifications.detail.summary.status_reason' => "Status Reasoning",
  :'en.insured.families.verifications.detail.summary.due_on' => "Due Date",
  :'en.insured.families.verifications.detail.verification_details' => "Verification Details",
  :'en.insured.families.verifications.detail.document_upload' => "Document Upload",
  ...
  :'en.insured.families.verifications.detail.document_upload_history' => "Upload History",
  :'en.insured.families.verifications.detail.view_upload_history' => "View Upload History",
  :'en.insured.families.verifications.detail.view_upload_history_text' => "Documents uploaded for your most recent application. To see all uploads for income across prior applications, select the %{history_button_text} button.",
  ...
  :'en.insured.families.verifications.individual.faa_evidence_banner_text' => "You're viewing verifications for your latest application. To see verifications from a previous application, please see",
  :'en.insured.families.verifications.individual.faa_evidence_banner_link_text' => "Previous Application Verifications",
  :'en.insured.families.verifications_back_to' => "Back to ",
  :'en.insured.families.verifications_return_to' => "Return to ",
  :'en.insured.families.verifications_upload_history' => "Verification Upload History",
  :'en.insured.families.verification_documents' => "Verification Documents",
  :'en.financial_assistance' => 'Financial Assistance',
  :'en.insured.marketplace_plan' => 'Marketplace Plan',
  :'en.insured.sbm.applications.eligibility' => "Eligibility",
  :'en.insured.sbm.applications.index.pre_oe_warning1' => "We’ve created your 2026 application using your current information.",
  ...
  :'en.insured.sbm.applications.table.status' => "Status",
  :'en.insured.sbm.applications.table.started' => "Started",
  :'en.insured.sbm.applications.table.submission' => "Submission",
  :'en.insured.sbm.applications.actions.update' => 'Update Application',
  :'en.insured.sbm.applications.actions.copy' => 'Copy to New Application',
  :'en.insured.sbm.applications.actions.view_eligibility' => 'View Eligibility Determination',
  :'en.insured.sbm.applications.actions.view_criteria' => 'View Eligibility Criteria',
  :'en.insured.sbm.applications.actions.review' => 'Review Application',
  :'en.insured.sbm.applications.actions.full_application' => 'Full Application',
  :'en.insured.sbm.applications.actions.transfer_history' => 'Transfer History',
  :'en.insured.sbm.applications.actions.eligibility_criteria' => 'Eligibility Criteria',
  :'en.insured.sbm.applications.actions.update_year' => "Update %{year} Application",
  :'en.insured.sbm.applications.actions.copy_to_alt_year' => "Copy Info to %{alt_year} Application",
  ...
  :'en.insured.group_selection.new.select_who_needs_coverage' => "Select who needs coverage and the type of coverage needed. When you’re finished, select 'Continue to Next Step'.",
  ...
  :'en.application_reference' => 'Application Reference',
  :'en.select_application_reference' => 'Select Application Reference',
  :'en.select_reason' => 'Select Reason',
  ...
  :'en.insured.plan_shoppings.show.health_title.content' => "To enroll in a plan, use 'Select Plan' on the plan tile. To help you find a plan that's right for you, return to the 'Previous Step' and use the Plan Comparison Tool.",
  ...
  :'en.insured.plan_shoppings.thankyou.confirm_your_plan_selection.content_without_agreement' => "Please review your current plan selection. Select Previous Step if you want to change your plan selection. When you're satisfied with your plan, carefully review and acknowledge the Terms and Conditions. You must also provide an electronic signature at the bottom of the page. When you're finished, select CONFIRM to submit your enrollment to your insurance company. You don't have to pay today.",
  ...
  :'en.insured.individual_agreement.agreement.aptc.if_changes.irs_compares' => "I also understand that when I file my %{coverage_year} federal income tax return, the Internal Revenue Service (IRS) will compare the income on my tax return with the income on my application. I understand that if the income on my tax return is lower than the amount of income on my application, I may be eligible to get an additional premium tax credit amount. If the income on my tax return is greater than the amount of income on my application, I may owe additional federal income tax.",
  ...
  :'en.return_to_applications' => "Return to Applications",
  :'en.your_tax_credit' => "Your Tax Credit",
  ...
  :'en.upload_doc_error' => "Upload failed. Please upload a PDF, JPEG, PNG, or GIF that is %{size_in_mb} MB or smaller.",
  ...
  :'en.qhp_application.nav.preferences_label' => "Preferences",
  :'en.qhp_application.nav.results' => "Eligibility Results",
  :'en.qhp_application.nav.enroll_in_coverage' => "Enroll in Coverage",
  :'en.qhp_application.nav.application_type' => "Application Type",
  :'en.qhp_application.new_member' => "New Member",
  :'en.qhp_application.remove_mailing' => "Remove Mailing Address",
  :'en.qhp_application.add_mailing' => "Add Mailing Address",
  ...
  :'en.qhp_application.review.ai_na_member' => "Is this person a member of an American Indian or Alaska Native Tribe?",
  :'en.qhp_application.review.tribe_info' => "Tribe Information",
  :'en.qhp_application.review.immigration_info' => "Immigration Information",
  :'en.qhp_application.review.immigration.type' => "Document Type",
  :'en.qhp_application.review.address_info' => "Address Information",
  :'en.qhp_application.review.contact_info' => "Contact Information",
  :'en.qhp_application.review.state_resident_experiencing_homelessness' => "State Resident Experiencing Homelessness",
  ...
  :'en.insured.preferences.update_address' => 'If you need to update your home or mailing address, go to the ',
  :'en.insured.preferences.family_info_page' => 'family info page',
  :'en.insured.preferences.provide_info' => 'Please provide as much information as possible.',
  :'en.insured.preferences.description.contact_info' => 'Please provide us with your contact preferences. This will be used to assist the call center if you forget your password.',
  :'en.insured.preferences.description.required_notice_1' => 'An email or mobile phone number is required.',
  :'en.insured.preferences.description.required_notice_2' => 'When you’re finished, select ',
  ...
  :'en.insured.preferences.both_methods' => 'Both electronic and paper communications',
  :'en.insured.preferences.select_communications' => 'Select communications preference',
  :'en.insured.preferences.language_preferences' => 'Language Preferences',
  ...
  :'en.qhp_application.show.full_application_details_description' => "Select 'Edit Section' to make updates to your information. Your changes won't be final until you submit your updated application.",
  ...
  :'en.qhp_application.show.eligibility_results' => "View Eligibility Results",
  :'en.qhp_applicant.show.return' => "Return to Eligibility Info",
  :'en.qhp_application.show.add_member' => "Add Member to Household",
  :'en.qhp_application.show.return' => "Return to Applications",
  :'en.qhp_application.show.member_details_description' => "Select 'Edit Section' to make updates to your information. Your changes won't be final until you submit your updated application.",
  ...
  :'en.qhp_application.not_applying_for_coverage' => 'Not Applying for Coverage',
  :'en.qhp_application.eligibility_criteria.bases.applying_coverage' => 'Applying for Coverage',
  :'en.qhp_application.eligibility_criteria.bases.state_resident' => 'State Resident',
  ...
  :'en.insured.leaving_modal.warning_description' => 'Any changes you’ve made won’t take effect until you submit the application. If you leave now, your application will be saved as a draft and you can finish it later.',
  ...
  :'en.draft' => 'Draft',
  :'en.determination_error' => 'Determination Error',
  :'en.determined' => 'Determined',
  :'en.qhp_application.not_answered' => 'Not answered',
  :'en.qhp_application.zip.empty' => 'Please provide a zip code',
  :'en.qhp_application.zip.outside' => 'Zip code outside supported area',
  :'en.qhp_application.member_details.header' => '%{name}\'s Details',
  :'en.insured.sbm.applications.application_history' => 'View Application History',
  :'en.insured.sbm.applications.application_history_description1' => 'The information below reflects your most recent application for each coverage year. You can apply for coverage, review and update an application, or view eligibility determinations from this page. To review older applications, select ',
  :'en.insured.sbm.applications.application_history_description3' => ' at the bottom of this page.',
  :'en.insured.sbm.applications.application_history_description2' => 'View Application History',
  :'en.applications.program.did_not_apply' => 'Did Not Apply',
  :'en.applications.program.qhp_plan' => '%{short_name} Plan',
  :'en.applications.program.not_eligible' => 'Not Eligible',
  :'en.applications.program.may_qualify_for_medicaid' => 'May Qualify for MaineCare',
  :'en.applications.resume' => "Resume %{year} Application",
  :'en.applications.start' => "Start %{year} Application",
  :'en.applications.how.start' => 'To start a new application',
  :'en.applications.how.start.step1' => 'Choose the year you want to apply for coverage.',
  :'en.applications.how.start.start_application' => 'Start Application',
  ...
  :'en.applications.how.update' => 'To update an application',
  :'en.applications.how.update.step1' => 'Choose the year you want to update (either this year or last year).',
  :'en.applications.how.update.step2b' => 'drop-down next to that year.',
  :'en.applications.how.update.step2a' => 'Click the',
  :'en.applications.how.update.update_application' => 'Update Application',
  :'en.applications.how.update.step3.bullet' => 'Want to update information for just one person? Click their name directly.',
  ...
  :'en.applications.how.previous.li2a' => "Changes to your %{year} application do <u>not</u> carry over to %{year2}. If you update your %{year} application, be sure to select",
  :'en.applications.how.previous.li2b' => "drop-down and submit the updated %{year2} application.",
