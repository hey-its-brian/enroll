...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.preferences.contact_update_info' => 'Confirm your contact preferences. If you need to update your home or mailing address, go to the ',
...
now, your application will be saved as a draft and you can finish it later.',
  ...
  :'en.applications.how.start' => 'How to start a new application',
  :'en.applications.how.start.step1' => 'Choose the year you want to apply for coverage.',
  :'en.applications.how.start.step2' => 'Click \'<b>Start Application</b>\' or select the \'<b>Actions</b>\' drop-down and choose \'<b>Resume Draft</b>\'.',
  :'en.applications.how.start.step3' => 'If you’ve already submitted an application for a different year, you can save time by selecting \'<b>Copy Info to Application</b>\' from the \'<b>Actions</b>\' drop-down to reuse your information.',
  :'en.applications.how.update' => 'How to update an application',
  :'en.applications.how.update.step1' => 'Choose the year you want to update (either this year or last year).',
  :'en.applications.how.update.step2' => 'Click the \'<b>Actions</b>\' drop-down next to that year.',
  :'en.applications.how.update.step3' => 'Select \'<b>Update Application</b>\'.',
  :'en.applications.how.update.step3a' => 'Want to update information for just one person? Click their name directly.',
  ...
  :'en.applications.how.previous.li2' => "Changes to your %{year} application do <u>not</u> carry over to %{year2}. If you update your %{year} application, be sure to select \'<b>Copy Info to %{year2} Application</b>\' from the \'<b>Actions</b>\' drop-down and submit the updated %{year2} application.",
