...
-li- How to find the SEVIS ID: On the DS-2019, the number is on the top right hand side of the page in the box above the barcode.",
  ...
  :'en.insured.families.verifications.individual.faa_evidence_banner_text' => "Looking for the verifications for your previous financial assistance application?",
  :'en.insured.families.verifications.individual.faa_evidence_banner_link_text' => "Click here to access financial assistance verifications",
