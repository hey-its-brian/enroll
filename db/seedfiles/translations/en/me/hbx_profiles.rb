HBX_PROFILES_TRANSLATIONS = {
  ...
  "en.hbx_profiles.copy_tax_form_document.corrected_and_void_subject" => "Your Requested Copy of %{notice_type} 1095-A Tax Form",
  "en.hbx_profiles.copy_tax_form_document.original_subject" => "Your Requested Copy of 1095-A Tax Form",
