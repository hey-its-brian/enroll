ISSUER_PROFILE_DATA = [
  ...
  {
    fein: "873357382",
    issuer_hios_ids: ["54879"],
    legal_name: EnrollRegistry.feature?(:taro_rebranding) && EnrollRegistry.feature_enabled?(:taro_rebranding) ? "Mending Health" : "Taro Health Plan of Maine, Inc.",
    abbreviation: "TARO",
    hbx_carrier_id: 30_006,
    ivl_health: true
  }
]