...
# This script triggers the operation to backfill missing county information for person addresses.
#
# Usage:
#   CLIENT=me bundle exec rails runner script/data_fixes/backfill_family_faa_counties.rb "HBX_ID_1,HBX_ID_2,HBX_ID_3"
#
# Examples:
#   Single HBX ID:
#     CLIENT=me bundle exec rails runner script/data_fixes/backfill_family_faa_counties.rb "123456789"
#   
#   Multiple HBX IDs (comma-separated):
#     CLIENT=me bundle exec rails runner script/data_fixes/backfill_family_faa_counties.rb "123456789,987654321,456789123"
...
operation = ::Operations::DataFixes::BackfillPersonAddressCounties.new
