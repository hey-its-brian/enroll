...
module BenefitSponsors
  RSpec.describe Organizations::OrganizationForms::ProfileForm, type: :model, dbclean: :after_each do
    ...
    let(:model_attributes) do
      [:id, :market_kind, :is_benefit_sponsorship_eligible,:corporate_npn,:languages_spoken,:working_hours,:accept_new_clients,:home_page,:contact_method,:market_kind_options,:grouped_sic_code_options,:language_options,:contact_method_options,
       :profile_type,:sic_code,:inbox,:parent,:office_locations,:referred_by,:referred_reason,:referred_by_options]
    end
    ...
    describe "profile form" do
      ...
      context "profile_type == benefit_sponsor" do
        ...
        it ".is_assister_profile??" do
          new_form = subject.new params
          expect(new_form.is_assister_profile?).to eq false
        end
      end
      ...
      context "profile_type == assister_agency" do
        ...
        it ".is_assister_profile??" do
          new_form = subject.new params
          expect(new_form.is_assister_profile?).to eq true
        end
      end
    end
  end
