        ...
        module H31
          ...
          class AddNonEsiMecDetermination
            ...
            def update_aptc_csr_eligibility_evidence(applicant, response_applicant_entity, call_type)
              ...
              status = response_non_esi_evidence.aasm_state
              update_non_esi_mec_evidence(non_esi_mec_evidence, status, call_type)

              response_non_esi_evidence.request_results&.each do |request_result|
