...
module FinancialAssistance
  module Evidences
    # EvidencePolicy is a policy class that defines permissions for actions related to evidence records.
    # It inherits from ApplicationPolicy and provides methods to check if a user can upload, download and delete
