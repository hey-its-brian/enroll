...
RSpec.describe FinancialAssistance::Evidences::EsiMecEvidence, type: :model do
  ...
  let(:evidence)              { FactoryBot.create(:esi_mec_evidence, eligibility: aptc_csr_eligibility) }
