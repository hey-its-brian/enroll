...
RSpec.describe FinancialAssistance::Evidences::NonEsiMecEvidence, type: :model do
  ...
  let(:evidence)              { FactoryBot.create(:non_esi_mec_evidence, eligibility: aptc_csr_eligibility) }
