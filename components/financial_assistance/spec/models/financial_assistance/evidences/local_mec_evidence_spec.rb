...
RSpec.describe FinancialAssistance::Evidences::LocalMecEvidence, type: :model do
  ...
  let(:evidence)              { FactoryBot.create(:local_mec_evidence, eligibility: aptc_csr_eligibility) }
