...
FINANCIAL_ASSISTANCE_TRANSLATIONS = {
  ...
  "en.faa.tax_info.household_member" => "Household Member",
  ...
  'en.faa.last_step_3' => "This is the last step. Carefully read the information below. Select 'I agree' after each statement to acknowledge your agreement. Then, enter your name to electronically sign the application. When you're finished, select ",
  'en.faa.submit_application_text' => "'Submit Application'.",
  ...
  'en.faa.electronic_signature_additional_text' => 'When I type my name below, it means I sign the form and promise that all of the information in it is true and complete to the best of my knowledge.',
  ...
  "en.faa.results.aptc_text" => "These people are eligible to enroll in an insurance plan on %{short_name} and qualify for a premium tax credit of $%{aptc} per month to help lower their monthly payment. This financial assistance will be applied during plan selection.",
  ...
  "en.faa.results.medicaid_or_chip_text2a" => "While this application is being reviewed by %{medicaid_short_name}, the people listed below are eligible to enroll in an insurance plan on %{short_name}, but they are not eligible for financial assistance.",
  ...
  "en.faa.results.uqhp_text" => "These people are eligible to enroll in an insurance plan on %{short_name} but are not eligible for financial assistance.",
  "en.faa.results.totally_ineligible_heading" => "Does Not Qualify",
  "en.faa.results.totally_ineligible_text" => "These people are not eligible to enroll in an insurance plan on %{short_name} and likely don't qualify for %{medicaid_or_chip_program_short_name}.",
  "en.faa.results.not_applying_coverage_heading" => "Did Not Apply for Coverage",
  ...
  "en.faa.results.qhp_all_medicaid_next_steps_continue_text" => "MaineCare coverage is free. If you enroll in a plan through %{short_name} while OFI is still reviewing your MaineCare eligibility, you’ll need to pay the full price for that plan.",
  ...
  "en.faa.results.continue_text" => "Select '%{continue_text}' to see if you are eligible to select a new plan or make changes to your current plan.",
  ...
  'en.faa.program_eligibility.did_not_apply' => 'Did Not Apply',
  'en.faa.program_eligibility.ineligible' => 'Not Eligible',
  'en.faa.program_eligibility.eligible' => "%{short_name} with Financial Assistance",
  'en.faa.program_eligibility.may_qualify_for_medicaid' => "May Qualify for MaineCare",
  'en.faa.program_eligibility.plan_without_financial_assistance' => "%{short_name} Plan without Financial Assistance",
  'en.faa.flash_alerts.uneditable_application' => 'This application is not editable.',
  'en.faa.remove_financial_assistance_application' => 'Remove Financial Assistance Application',
  'en.faa.remove_financial_assistance_application_warning' => 'Are you sure you want to remove your application for financial savings?',
  'en.faa.remove_financial_assistance_application.body_1' => "If you remove your application for financial assistance, any tax credits or cost-sharing reductions you currently receive will end. We also won't check if anyone in your household qualifies for %{medicaid_short_name}.",
  'en.faa.remove_financial_assistance_application.body_2' => "To continue, select ",
  'en.faa.remove_financial_assistance_application.body_3' => "You'll then be asked to confirm some household information.",
  'en.faa.remove_financial_assistance_application.cancel' => 'If you want to keep your financial savings, select ',
